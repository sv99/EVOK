...
namespace evokNew0056
{
    public partial class WorkForm : Form
    {
        ...
        void controlShow()
        {
            ...
            button64.Visible = false; //防崩边

            label65.Text = Constant.msjLabel1;
            label66.Text = Constant.msjLabel0;
        ...
        void showControlById(int id)
        {
            ...
            if (comboBox5.Text.Equals(Constant.hyCutType[0]))
            {
                button40.Visible = false;
            ...
            //29 26 24 4
            if (comboBox5.Text.Equals(Constant.hyCutType[3]))
            {
                ...
                label65.Text = Constant.msjLabel2;
                label66.Text = Constant.msjLabel3;
